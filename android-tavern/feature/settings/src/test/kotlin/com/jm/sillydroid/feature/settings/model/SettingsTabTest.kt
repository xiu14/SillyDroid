...
class SettingsTabTest {
    ...
    fun `fromTabPosition maps all supported tab positions`() {
        ...
        assertEquals(SettingsTab.BACKUP, SettingsTab.fromTabPosition(2))
        ...
        assertEquals(SettingsTab.TERMINAL, SettingsTab.fromTabPosition(5))
        assertEquals(SettingsTab.LOGS, SettingsTab.fromTabPosition(6))
    }
    ...
    fun `fromTabPosition falls back to data for unsupported positions and about has no tab slot`() {
        ...
        assertEquals(SettingsTab.DATA, SettingsTab.fromTabPosition(8))
    }
}
